# Inform 7 - Greek Version

Το παρόν αποθετήριο αποτελεί fork του original αποθετηρίου για το Inform 7, και σε αυτό θα περιλαμβάνονται επιπλέον οδηγίες για όλα τα εργαλεία και τις προσθήκες που απαιτούνται, με στόχο τον εξελληνισμό της εφαρμογής κατά το δυνατόν.

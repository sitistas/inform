...
The kitchen είναι ένα δωμάτιο.
[ Υπνοδωμάτιο is a room. Υπνοδωμάτιο είμαι βόρεια της kitchen. ]

the lamp είναι συσκευή in the kitchen. the lamp is switched off.
...
έντεκα marbles are in the kitchen. The description of a marble is "Ένα μικρό, σφαιρικό, πολύχρωμο αντικείμενο.".

[ A πρέσβης is a kind of thing. 10 πρέσβεις are in the kitchen. ]
[ A πρεσβης is a kind of thing. 10 πρεσβεις are in the kitchen. ]

Ένας μυς is ένα αντικείμενο. 10 μυς are in the kitchen.

A χαρακας is ένα πράγμα. 10 χαρακες are in the kitchen.
